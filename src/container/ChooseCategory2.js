...
const ChooseCategory = () => {
    ...
    return (
        <Fragment>
            <Col className="justify-content-md-center text-center" data-aos="fade-up" style={{ border:'2px solid red', padding: '20px', textTransform: 'uppercase' }} data-aos-delay="400" >
